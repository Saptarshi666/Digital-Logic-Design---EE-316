...
HD_PWD='C:/Users/deeps/Lab_3_part_3/Lab_3_part_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_TO_SEGMENT_DISPLAY.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_TO_SEGMENT_DISPLAY.tcl
