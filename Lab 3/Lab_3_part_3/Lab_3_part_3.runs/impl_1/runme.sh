...
HD_PWD='C:/Users/deeps/Lab_3_part_3/Lab_3_part_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_TO_SEGMENT_DISPLAY.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_TO_SEGMENT_DISPLAY.tcl -notrace
